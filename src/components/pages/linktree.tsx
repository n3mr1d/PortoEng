...
import { ExternalLink, Link, Mail, Github, Twitter, Linkedin, Instagram, Facebook, PhoneCall, Heart, UserSquareIcon }
from
"lucide-react";
...
<section className="relative bg-black min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
    ...
    <div className="absolute inset-0 opacity-30 transition-all duration-300" style={{ background: `radial-gradient(600px
        circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(255,255,255,0.1), transparent 80%)`, }} />

    {/* Grid pola garis */}
    <div className="absolute inset-0 opacity-10" style={{ backgroundImage: ` linear-gradient(rgba(255,255,255,0.05) 1px,
        transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.05) 1px, transparent 1px) `, backgroundSize:
        `${gridSize}px ${gridSize}px`, }} />

    {/* Logo di setiap perpotongan grid */}
    <div className="absolute inset-0 opacity-2" style={{ backgroundImage: `url(${logo})`, backgroundRepeat: "repeat" ,
        backgroundSize: `${gridSize}px ${gridSize}px`, backgroundPosition: "center center" , filter: "grayscale(1)" ,
        }}>
    </div>
        ...
        <div className="flex items-center flex-col justify-center mb-12 space-y-6">
            ...
            <div className="relative group">
                ...
                <Avatar
                    ...
                    <AvatarFallback className="bg-gradient-to-br from-gray-800 to-black text-5xl font-bold text-white">
